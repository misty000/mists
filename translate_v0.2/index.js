...
(function() {
  var $, $main, $processed, $raw, ATTR_TRANSLATE_KEY, DATA_COMPARE_KEY, Editor, Parser, Progress, clearCompare, compare, editor, loadDoc, parser, progress, removeCompare, toDecimal, updateCompare, updateProgress;
  ...
  $(function() {
    ...
    $('#translation').on('click', 'section', function() {
      return false;
    });
  ...
  $(function() {
    ...
    */
    ...
    return $('#translation').on('show', function() {
